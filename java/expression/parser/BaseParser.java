...
import expression.parser.exceptions.UnexpectedSymbolException;
...
public class BaseParser {
    ...
    protected void expect(final char c) throws UnexpectedSymbolException {
        if (ch != c) {
            throw new UnexpectedSymbolException(getPos() + ": Expected '" + c + "', found " + (ch == '\0' ? "EOF" : "'" + ch + "'"));
        }
        nextChar();
    }
